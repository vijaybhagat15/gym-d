    ...
    <div >
      ...
      <div className="container mx-auto px-6 py-16 font-sans">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          {/* Left Column: Image */}
          <div className="flex justify-cente  bg-indigo-400 rounded-3xl p-[1px]">
            <img
          ...
          <div className="container mx-auto text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
              ...
              <div className=" bg-white font-bold text-xl p-1 rounded-lg shadow-lg border-2 border-transparent  hover:scale-105 transition-transform">
                <img src="https://as1.ftcdn.net/v2/jpg/02/64/23/78/1000_F_264237813_6Yn9JJkBZkuGP9gEgebCA5xVqhqz76v3.jpg" alt="Trainer 1" className="w-full h-64 object-cover rounded-md mb-4 border-2 border-indigo-400" />
              ...
              <div className="  bg-white  font-bold text-xl p-1 rounded-lg shadow-lg border-2 border-transparent  hover:scale-105 transition-transform">
                <img
                  ...
                  alt="Trainer 3"
                  className="w-full h-64 object-cover rounded-2xl mb-4 border-2 border-indigo-400"
                />
            ...
            <div className="mt-16 bg-gradient-to-b  from-indigo-400 to-transparent py-12 text-center rounded-lg border-2 border-white">
